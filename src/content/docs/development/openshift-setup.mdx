...
| `spec.otel` | No | OpenTelemetry configuration. See [Architecture](architecture/) for details. |
...
- [Architecture](architecture/) - Adapter architecture
- [Python SDK](/reference/sdk-client/) - Client and adapter reference
