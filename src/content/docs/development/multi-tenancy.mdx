...
- A working EvalHub deployment (see [OpenShift Setup](openshift-setup/))
...
**List providers (scoped to team-a)** (or alternatively, use the [CLI](/getting-started/cli/))**:**
...
- [OpenShift Setup](openshift-setup/) -- Base deployment guide
