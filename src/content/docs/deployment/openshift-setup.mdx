---
title: "OpenShift Development Setup"
---
...
:::caution[Administrator Access Required]
...
2. **Deploy EvalHub Instance**
   ...
   <Tabs>
   <TabItem label="SQLite (development/testing)">
   ...
   | `spec.otel` | No | OpenTelemetry configuration. See [System Overview](/architecture/system-overview/) for details. |
...
2. **Upload Custom Operator Manifests**
   ...
   The process involves creating a PVC for manifests, patching the operator CSV to mount it, copying manifests in, and restarting the operators. This is based on the [OpenDataHub component development workflow](https://raw.githubusercontent.com/opendatahub-io/opendatahub-operator/refs/heads/main/hack/component-dev/README.md).
