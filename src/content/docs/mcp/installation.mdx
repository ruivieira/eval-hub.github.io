...
<Since version="X.X.X" /> <span style="font-size:0.75rem;color:var(--sl-color-gray-3)">(coming soon)</span>
...
<Since version="0.1.5" /> <span style="font-size:0.75rem;color:var(--sl-color-gray-3)">eval-hub-sdk (deprecated)</span>
