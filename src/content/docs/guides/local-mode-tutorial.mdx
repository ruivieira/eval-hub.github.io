...
6. **Configure eval-hub-server**
   ...
   **Alternative: REST API**
   ...
   Instead of creating provider YAML files, you can register providers via the REST API after completing Step 7 (starting the server). If you prefer this method, skip ahead to Step 7, start the server, then return here and run:

   ```bash
   BASE_URL="http://localhost:8080"

   curl -s -X POST "${BASE_URL}/api/v1/evaluations/providers" \
     -H "Content-Type: application/json" \
     -d '{
       "id": "lighteval",
       "name": "LightEval",
   ...
   Verify the provider was created and note the generated UUID:

   ```bash
   evalhub providers list
   ```

   Example output (your provider ID will differ):

   ```text
   ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━┓
   ┃ ID                                   ┃ NAME      ┃ DESCRIPTION                        ┃ BENCHMARKS ┃
   ┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━┩
   │ accd31b1-2b69-454e-a7a9-9f6c8ca91ae5 │ LightEval │ LightEval for evaluation framework │ 1          │
   └──────────────────────────────────────┴───────────┴────────────────────────────────────┴────────────┘
   ```

   When using the REST API, use the returned UUID as the `--provider` value in `evalhub eval run` (replacing `lighteval` in the examples below).
