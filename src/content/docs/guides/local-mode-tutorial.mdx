...
2. **Install dependencies**
   ...
   :::tip
   Whenever the tutorial asks you to open or use another terminal, activate the virtual environment first with `source .venv/bin/activate` — even when not explicitly mentioned.
   :::
