...
Check [`docs/dataset-mapping.md`](https://github.com/opendatahub-io/lm-evaluation-harness/blob/incubation/docs/dataset-mapping.md) for the correct `dataset_path` and `dataset_name` for your benchmark:
