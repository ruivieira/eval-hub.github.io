...
- [Overview](/getting-started/overview/) - Architecture and core concepts
- [Installation](/getting-started/installation/) - Install server and SDK
- [Quick Start](/getting-started/quickstart/) - Run your first evaluation
- [Model authentication](/getting-started/model-authentication/) - API key, CA cert, and ServiceAccount token
- [Using custom data](/getting-started/custom-data/) - Using custom benchmark test data
- [Python SDK Reference](/reference/sdk-client/) - Client and adapter API
